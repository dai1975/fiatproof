...
defop!(OP_0x01, 0x01); defop!(OP_0x02, 0x02); defop!(OP_0x03, 0x03);
defop!(OP_0x04, 0x04); defop!(OP_0x05, 0x05); defop!(OP_0x06, 0x06); defop!(OP_0x07, 0x07);
defop!(OP_0x08, 0x08); defop!(OP_0x09, 0x09); defop!(OP_0x0A, 0x0A); defop!(OP_0x0B, 0x0B);
defop!(OP_0x0C, 0x0C); defop!(OP_0x0D, 0x0D); defop!(OP_0x0E, 0x0E); defop!(OP_0x0F, 0x0F);
defop!(OP_0x10, 0x10); defop!(OP_0x11, 0x11); defop!(OP_0x12, 0x12); defop!(OP_0x13, 0x13);
defop!(OP_0x14, 0x14); defop!(OP_0x15, 0x15); defop!(OP_0x16, 0x16); defop!(OP_0x17, 0x17);
defop!(OP_0x18, 0x18); defop!(OP_0x19, 0x19); defop!(OP_0x1A, 0x1A); defop!(OP_0x1B, 0x1B);
defop!(OP_0x1C, 0x1C); defop!(OP_0x1D, 0x1D); defop!(OP_0x1E, 0x1E); defop!(OP_0x1F, 0x1F);
defop!(OP_0x20, 0x20); defop!(OP_0x21, 0x21); defop!(OP_0x22, 0x22); defop!(OP_0x23, 0x23);
defop!(OP_0x24, 0x24); defop!(OP_0x25, 0x25); defop!(OP_0x26, 0x26); defop!(OP_0x27, 0x27);
defop!(OP_0x28, 0x28); defop!(OP_0x29, 0x29); defop!(OP_0x2A, 0x2A); defop!(OP_0x2B, 0x2B);
defop!(OP_0x2C, 0x2C); defop!(OP_0x2D, 0x2D); defop!(OP_0x2E, 0x2E); defop!(OP_0x2F, 0x2F);
defop!(OP_0x30, 0x30); defop!(OP_0x31, 0x31); defop!(OP_0x32, 0x32); defop!(OP_0x33, 0x33);
defop!(OP_0x34, 0x34); defop!(OP_0x35, 0x35); defop!(OP_0x36, 0x36); defop!(OP_0x37, 0x37);
defop!(OP_0x38, 0x38); defop!(OP_0x39, 0x39); defop!(OP_0x3A, 0x3A); defop!(OP_0x3B, 0x3B);
defop!(OP_0x3C, 0x3C); defop!(OP_0x3D, 0x3D); defop!(OP_0x3E, 0x3E); defop!(OP_0x3F, 0x3F);
defop!(OP_0x40, 0x40); defop!(OP_0x41, 0x41); defop!(OP_0x42, 0x42); defop!(OP_0x43, 0x43);
defop!(OP_0x44, 0x44); defop!(OP_0x45, 0x45); defop!(OP_0x46, 0x46); defop!(OP_0x47, 0x47);
defop!(OP_0x48, 0x48); defop!(OP_0x49, 0x49); defop!(OP_0x4A, 0x4A); defop!(OP_0x4B, 0x4B);
