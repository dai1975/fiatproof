...
//!  let xpub_decoder = ::fiatproofcrate::ui::bitcoin::MAINNET.create_xpub_decoder();
...
//!  let xprv_decoder = ::fiatproofcrate::ui::bitcoin::MAINNET.create_xprv_decoder();
...
//!
//! ```
//! let seed = ::fiatproofcrate::utils::h2b("000102030405060708090a0b0c0d0e0f").unwrap();
//! let xprv = ::fiatproof::crypto::bip32::XPrv::from_seed(seed).unwrap();
//! let xpub = xprv.xpub;
//! ```
//! 
