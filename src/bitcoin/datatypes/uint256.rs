...
impl ::std::fmt::Display for UInt256 {
   fn fmt(&self, f: &mut ::std::fmt::Formatter) -> ::std::fmt::Result {
      match ::ui::BitcoinSerializer::serialize(self, &()).then(|b| ::utils::b2h_rev(b)) {
...
fn test_str() {
   ...
   let uint256 = ::ui::BitcoinDeserializer::hex_to_uint256(s);
...
fn test_encode() {
   ...
   let octets = ::ui::BitcoinSerializer::serialize(&v, &());
...
fn test_decode() {
   ...
   let r = ::ui::BitcoinDeserializer::deserialize(&mut v, &());
