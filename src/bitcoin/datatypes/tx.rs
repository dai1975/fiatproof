...
use crate::iostream::HashWriteStream;
...
impl Tx {
   ...
   pub fn get_hash(&self) -> crate::Result<Box<[u8]>> {
      let mut ws = HashWriteStream::new(DHash256::new());
      let med = Medium::new("net")?;
      let enc = Serializer::new(&med);
      let _size = self.serialize(&(), &enc, &mut ws)?;
      Ok(ws.result())
   }
}
...
fn test_deserialize_transaction() {
   ...
   let tx = crate::ui::bitcoin::hex_to_tx(hex);
   ...
   assert_eq!(crate::ui::bitcoin::script_to_hex(&tx.outs[0].script_pubkey).unwrap(), "76a914a3d89c53bb956f08917b44d113c6b2bcbe0c29b788ac");
   assert_eq!(tx.outs[1].value, 155000000);
   assert_eq!(crate::ui::bitcoin::script_to_hex(&tx.outs[1].script_pubkey).unwrap(), "76a91408338e1d5e26db3fce21b011795b1c3c8a5a5d0788ac");
}
...
fn test_serialize_transaction() {
   ...
   tx.ins.push(TxIn {
      prevout: TxOutPoint {
         txid: crate::ui::bitcoin::hex_to_uint256("4d6da9420d472b6b52c36eee132d87448bf160d8839a58afdd2add6f6adfc8d8").unwrap(),
         n:0
      },
   ...
   tx.ins.push(TxIn {
      prevout: TxOutPoint {
         txid: crate::ui::bitcoin::hex_to_uint256("b220a19ba645c021f0cf501435fd6c3b4db960325d0834612612a5684ffab32a").unwrap(),
         n:0
      },
   ...
   tx.outs.push(TxOut {
      value: 39000000,
      script_pubkey: crate::ui::bitcoin::hex_to_script("76a914a3d89c53bb956f08917b44d113c6b2bcbe0c29b788ac").unwrap(),
   });
   tx.outs.push(TxOut {
      value: 155000000,
      script_pubkey: crate::ui::bitcoin::hex_to_script("76a91408338e1d5e26db3fce21b011795b1c3c8a5a5d0788ac").unwrap(),
   });

   assert_eq!(crate::ui::bitcoin::tx_to_hex(&tx).unwrap(), "");
   
   //assert_eq!(crate::ui::bitcoin::tx_to_txid(&tx).unwrap(), "9021b49d445c719106c95d561b9c3fac7bcb3650db67684a9226cd7fa1e1c1a0");
   assert_eq!(crate::ui::b2h_rev(tx.get_hash().unwrap()), "9021b49d445c719106c95d561b9c3fac7bcb3650db67684a9226cd7fa1e1c1a0");
}
